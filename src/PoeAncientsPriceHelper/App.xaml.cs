...
public partial class App : System.Windows.Application
{
    ...
    {
        if (!GroundLootScanEngine.IsShowing) return;
        PriceOverlayManager.HideNow();   // instant, off the scan loop
        GroundLootScanEngine.RequestDismiss();
    }
    ...
    {
        bool wantWatch = GroundLootScanEngine.IsShowing || RumourScanEngine.IsShowing;
        lock (_clickGate)
        {
